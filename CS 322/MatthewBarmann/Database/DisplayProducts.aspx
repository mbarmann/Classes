<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DisplayProducts.aspx.cs" Inherits="MatthewBarmann.Pages.DisplayProducts" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server"> 
    ...
    <asp:TableHeaderRow>
          ...
          <asp:TableHeaderCell>Inventory Number</asp:TableHeaderCell>
